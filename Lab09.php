   ...
   //              </a>
			// </li>
			  foreach($images as $key => $val){
                                    print ' <li><a href="detail.php?id= ' . $val["id"]. '"class="img-responsive"><img src="images/square/' . $val["path"] . '" alt="' . $val["title"] . '"><div class="caption"><div class="blur"></div><div class="caption-text"><h1>' .  $val["title"] .  '</h1></div></div></a></li>';
                                    }
          ?>
